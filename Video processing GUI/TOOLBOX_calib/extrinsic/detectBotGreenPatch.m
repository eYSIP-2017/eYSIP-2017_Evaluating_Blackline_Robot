function[BotCentroid, ConvexImage, ExtremaBoxBot, boundingBoxBot, stats] = detectBotGreenPatch(data)
...
%     
%     hue_img = hsv_img(:,:,1);
%     hue_img(hue_img<0.15)=0;
%     hue_img(hue_img>0.6)=0;
%     hue_img(hue_img>0)=1;
%     
%     saturation_img = hsv_img(:,:,2);
%     saturation_img(saturation_img<0.36)=0;
%     saturation_img(saturation_img>0)=1;
%     
%     value_img = hsv_img(:,:,3);
%     value_img(value_img>0.8)=0;
%     value_img(value_img>0)=1;
%     
